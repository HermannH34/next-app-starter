...
function ProtoTestimonials({ variant }) {
  const c = accent(variant)
  const isTerminal = variant === "1"
  const isAgency = variant === "2"
...
function ProtoCTAFinal({ variant }) {
  const c = accent(variant)
  const isTerminal = variant === "1"
  const isAgency = variant === "2"
